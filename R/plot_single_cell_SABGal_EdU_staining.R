plot_single_cell_SABGal_EdU_staining <- function(data,
  ...
  ggplot(data,
    ...
    geom_vline(data = data_thresholds, aes(xintercept = SABGal_threshold_average_log10)) +
    geom_hline(data = data_thresholds, aes(yintercept = EdU_threshold_average_log10)) +
